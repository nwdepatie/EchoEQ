...
#
# EchoEQ_proj.tcl: Tcl script for re-creating project 'EchoEQ'
#
# Generated by Vivado on Mon Apr 15 21:19:04 EDT 2024
...
#
# 1. This project restoration tcl script (EchoEQ_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/media/nwdepatie/shared/workdir/Courses/FPGA/PROJ/EchoEQ/hardware/EchoEQ/EchoEQ.srcs/utils_1/imports/synth_1/EchoEQ_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/media/nwdepatie/shared/workdir/Courses/FPGA/PROJ/EchoEQ/hardware/coef.coe"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/EchoEQ/EchoEQ.srcs/utils_1/imports/synth_1/EchoEQ_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/coef.coe"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/EchoEQHLS"]"]"\
  ]
  foreach ipath $paths {
...
set script_file "EchoEQ_proj.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/EchoEQ"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/EchoEQHLS"]" $obj
...
set_property -name "top" -value "EchoEQ_wrapper" -objects $obj
...
set file "synth_1/EchoEQ_wrapper.dcp"
...
# Proc to create BD EchoEQ
proc cr_bd_EchoEQ { parentCell } {
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.554488",
   "Default View_TopLeft":"0,-312",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 7 -x 2230 -y 130 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 7 -x 2230 -y 150 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -x 2000 -y 180 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 4 -x 1300 -y 330 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 5 -x 1650 -y 410 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 200 -y 340 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 4 -x 1300 -y 130 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -x 1650 -y 160 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 550 -y 160 -defaultsOSRD
preplace inst axi_bram_ctrl_1 -pg 1 -lvl 3 -x 910 -y 360 -defaultsOSRD
preplace inst biquad_filt_0 -pg 1 -lvl 3 -x 910 -y 190 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 10 440 380 320 720 100 1090 250 1490 10 1800 70 2200
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 20 490 NJ 490 NJ 490 NJ 490 NJ 490 NJ 490 2200
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 390 330 700 70 1120 410 1500
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 4 1 1480 330n
preplace netloc axi_bram_ctrl_1_BRAM_PORTA 1 3 2 1090 420 NJ
preplace netloc axi_dma_0_M_AXIS_MM2S 1 2 3 730 10 NJ 10 1480
preplace netloc axi_dma_0_M_AXI_MM2S 1 4 1 N 70
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 N 90
preplace netloc axi_mem_intercon_M00_AXI 1 5 1 N 160
preplace netloc biquad_filt_0_m_axi_gmem 1 3 1 1110 180n
preplace netloc biquad_filt_0_y 1 3 1 1100 100n
preplace netloc processing_system7_0_DDR 1 6 1 NJ 130
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ 150
preplace netloc processing_system7_0_M_AXI_GP0 1 1 6 400 480 NJ 480 NJ 480 NJ 480 NJ 480 2210
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 2 710 80 NJ
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 N 160
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 710 180n
levelinfo -pg 1 -10 200 550 910 1300 1650 2000 2230
pagesize -pg 1 -db -bbox -sgen -10 0 2350 510
"
}
...
# End of cr_bd_EchoEQ()
cr_bd_EchoEQ ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files EchoEQ.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files EchoEQ.bd ] 
set_property IS_ENABLED "1" [get_files EchoEQ.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files EchoEQ.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files EchoEQ.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files EchoEQ.bd ] 
set_property PFM_NAME "" [get_files EchoEQ.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files EchoEQ.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files EchoEQ.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files EchoEQ.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files EchoEQ.bd ] 
set_property USED_IN_SIMULATION "1" [get_files EchoEQ.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files EchoEQ.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse EchoEQ.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/EchoEQ/EchoEQ.gen/sources_1/bd/EchoEQ/hdl/EchoEQ_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse EchoEQ.bd] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/EchoEQ.srcs/utils_1/imports/synth_1/EchoEQ_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/EchoEQ.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/EchoEQ.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/EchoEQ.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
